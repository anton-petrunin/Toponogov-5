...
In the following proof, we use only a small part of the classification in Lemma~\ref{lem:key}.
Namely, we use that if it is not the first case in the lemma, then there are two tense sets with a shared center.  
...
In addition, by construction, we get one of the identities in $(\asterism)$ with base point $v_2$.
