...
In a sense, our result is negative --- it was hard to imagine some new restrictions, but now we know there are none.
...
It still based on brute force search, and we hope that a more conceptual proof will be found latter.
...
Now, suppose exactly two ellipsoids are degenerate, note that it cannot be $P$.
